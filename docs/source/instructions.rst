...
you can use the first version of the cornea meta-atlas (hcornea_v1) together with the latest version of cPredictor (e.g. v0.3.2).
The docker containers are organised in this fashion: {version}_{tool}_{dataset}_{version}, like v0.3.2_cpredictor_hcornea_v1.
